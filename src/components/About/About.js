      ...
      <div className="Container">
        ...
        <ScrollAnimation animateIn="fadeInLeft">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
            Hello! My name is <strong>Reach Nou</strong>. I'm originally from Cambodia and currently, I'm living in USA. During my time here, I gained valuable experience through various entry-level positions, which greatly enhanced my work ethic, communication skills, and adaptability.
            </ScrollAnimation>
